...
module LED3_control(
clk, rst, btn, led_signal_R,led_signal_G,led_signal_B
    );
...
// number of the btn changes state.
...
// color reset and by using comparator, determine mean voltage.
